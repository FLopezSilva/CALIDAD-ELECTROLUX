...
{
    public partial class FormObservacionNota : Form
    {
        public FormObservacionNota()
        {
            InitializeComponent();
        }
        ...
        private Image Obt(){
            ...
            try
            {
                ...
                using (SqlCommand cmd = cn.CreateCommand())
                {
                    ...
                    cmd.Parameters.AddWithValue("@id", System.Data.SqlDbType.Image).Value = 2;
        ...
        */
        ...
        private void FormObservacionNota_Leave(object sender, EventArgs e)
        {
            this.Close();
        }
    }
