...
namespace Presentation.Opcion.MenuEnsayos.Pruebas
{
    ...
    public partial class FormEnsayoManual : Form
    {
        string inicio = DateTime.Now.ToString("HH:mm:ss");

        public FormEnsayoManual()
        {
            InitializeComponent();
        ...
        public bool reten() {
            ...
            if (numericInercia.Value < 60 && numericRetencion.Value < 15 ) {
        ...
        private void FormEnsayoManual_Load(object sender, EventArgs e)
        {
        ...
        private void numericResistencia_ValueChanged(object sender, EventArgs e)
        {
        ...
        private void FormEnsayoManual_Leave(object sender, EventArgs e)
        {
            this.Close();
        }
    }
