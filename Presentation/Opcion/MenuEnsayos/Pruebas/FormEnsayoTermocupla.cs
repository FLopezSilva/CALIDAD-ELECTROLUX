...
{
    public partial class FormEnsayoTermocupla : Form
    {
...

        {
            ...
            this.FormClosing += new FormClosingEventHandler(FormEnsayoTermocupla_FormClosing);
        ...
        private void FormTermocupla_Load(object sender, EventArgs e)
        {
        ...
        private void FormEnsayoTermocupla_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void textBoxTerm12_TextChanged(object sender, EventArgs e)
        {

        }

        private void textBoxTerm11_TextChanged(object sender, EventArgs e)
        {

        }

        private void textBoxTerm10_TextChanged(object sender, EventArgs e)
        {

        }

        private void databits_label_Click(object sender, EventArgs e)
        {

        }

        private void baudrate_label_Click(object sender, EventArgs e)
        {
        ...
        private void FormEnsayoTermocupla_Leave(object sender, EventArgs e)
        {
            _spManager.Dispose();
            this.Close();
        }

        private void FormEnsayoTermocupla_FormClosing(object sender, FormClosingEventArgs e)
        {
