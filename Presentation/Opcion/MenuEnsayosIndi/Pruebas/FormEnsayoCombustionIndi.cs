...
{
    public partial class FormEnsayoCombustionIndi : Form
    {
        string inicio = DateTime.Now.ToString("HH:mm:ss");
        float z = Convert.ToSingle(0.015);
        float x = Convert.ToSingle(0.010);
        public FormEnsayoCombustionIndi()
        {
            InitializeComponent();
        }
        ...
        private void btnTerminar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("REVISE LOS DATOS", "ERROR");
        ...
        private void FormEnsayoCombustionIndi_Leave(object sender, EventArgs e)
        {
            this.Close();
        }
    }
