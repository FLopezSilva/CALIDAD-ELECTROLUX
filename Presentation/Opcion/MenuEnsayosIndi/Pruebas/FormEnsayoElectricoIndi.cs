...
namespace Presentation.Opcion.MenuEnsayosIndi.Pruebas
{
    ...
    public partial class FormEnsayoElectricoIndi : Form
    {
        string inicio = DateTime.Now.ToString("HH:mm:ss");
        SerialPortManager _spManager;


        public FormEnsayoElectricoIndi()
        {
            InitializeComponent();
            UserInitialization();
...

        {
            ...
            this.FormClosing += new FormClosingEventHandler(FormEnsayoElectricoIndi_FormClosing);
        }
        ...
        private void FormEnsayoElectricoIndi_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void FormEnsayoElectricoIndi_Leave(object sender, EventArgs e)
        {
            _spManager.Dispose();
            this.Close();
        }
