...
{
    public partial class FormEnsayoNivelacionIndi : Form
    {

        string tiem_inicio = DateTime.Now.ToString("HH:mm:ss");

        public FormEnsayoNivelacionIndi()
        {
            InitializeComponent();
        }
        ...
        private void FormEnsayoNivelacionIndi_Leave(object sender, EventArgs e)
        {
            this.Close();
        }
